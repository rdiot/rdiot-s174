...
// Set up for data display
  ...
  // Set minute
  writeByte(DS3231_ADDRESS, MINUTE, 0x34);
  // Set hour, AM/PM (PM = bit 5 = 1), 12-hour display (bit 6 = 1) or 24-hour display (bit 6 = 0)
  writeByte(DS3231_ADDRESS, HOUR, 0x11 | 0x20 | 0x40);
  // Set date
  writeByte(DS3231_ADDRESS, DATE, 0x04);
  // Set day
  writeByte(DS3231_ADDRESS, DAY, 0x04);
  // Set month
  writeByte(DS3231_ADDRESS, MONTH, 0x07);
  // Set Year
  writeByte(DS3231_ADDRESS, YEAR, 0x16); 
